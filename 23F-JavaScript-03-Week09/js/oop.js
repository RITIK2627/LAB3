...
var hamburger = {
    ...
    sauces: ["mayo", "barbecue"],
    patties: "veggie",
    pattyCount: 2,
    extras: ["pickles", "bacon"],
    describe: function() {
        this.out = {
            text: `This hamburger has a ${this.pattyCount > 1 ? this.pattyCount + "-patty" : "single-patty"} ${this.patties} burger on a ${this.bun} bun with ${this.veggies.join(", ")}, ${this.cheeses.join(", ")} cheese, topped with ${this.sauces.join(", ")} sauce and additional extras like ${this.extras.join(", ")}.`
        };
...
output.textContent = hamburger.describe();
